object Background: TBackground
  ...
  object StreamerHeader: TPanel
    ...
    ParentFont = False
    TabOrder = 1
    OnClick = StreamerHeaderClick
  end
  object RightSidebar: TPanel
    Left = -24
    Top = -22
    Width = 345
    Height = 183
    ...
    object HelpButton: TPanel
      ...
      OnMouseEnter = HelpButtonMouseEnter
      OnMouseLeave = HelpButtonMouseLeave
    end
    object BrowseButton: TPanel
      Left = 16
      Top = 64
      Width = 185
      Height = 41
      ...
      OnMouseEnter = BrowseButtonMouseEnter
      OnMouseLeave = BrowseButtonMouseLeave
    end
    object LogoutButton: TPanel
      Left = 156
      Top = 180
      Width = 185
      Height = 41
      ...
      OnMouseEnter = LogoutButtonMouseEnter
      OnMouseLeave = LogoutButtonMouseLeave
    end
  ...
  object LoginPanel: TPanel
    ...
    object PasswordField: TMaskEdit
      Left = 272
      Top = 109
      Width = 121
      Height = 23
    ...
    object LoginCancel: TPanel
      ...
      ParentFont = False
      TabOrder = 4
      OnClick = LoginCancelClick
      OnMouseEnter = LoginCancelMouseEnter
      OnMouseLeave = LoginCancelMouseLeave
    end
    object SubmitLoginButton: TPanel
      Left = 240
      Top = 151
      Width = 185
      Height = 41
      ...
      ParentFont = False
      TabOrder = 5
      OnClick = SubmitLoginButtonClick
      OnMouseEnter = SubmitLoginButtonMouseEnter
      OnMouseLeave = SubmitLoginButtonMouseLeave
    end
  end
  object UserGreet: TPanel
    Left = 586
    Top = 373
    Width = 105
    Height = 25
    BevelOuter = bvNone
    Caption = 'HELLO. PLEASE LOG IN.'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = 27612
    Font.Height = -11
    Font.Name = 'Fixedsys'
  ...
  object ErrorPanel: TPanel
    ...
    object ErrorOkButton: TPanel
      ...
      ParentFont = False
      TabOrder = 0
      OnClick = ErrorOkButtonClick
      OnMouseEnter = ErrorOkButtonMouseEnter
      OnMouseLeave = ErrorOkButtonMouseLeave
    end
    object ErrorClose: TPanel
      Left = 16
      Top = 16
      Width = 19
      Height = 25
      ...
      TabOrder = 1
      OnClick = ErrorOkButtonClick
      OnMouseEnter = ErrorCloseMouseEnter
      OnMouseLeave = ErrorCloseMouseLeave
    end
    object ErrorMessageBox: TPanel
      Left = 40
      Top = 50
      Width = 185
      Height = 41
  ...
  object VideoPlayerPanel: TPanel
    Left = 359
    Top = 24
    Width = 289
    Height = 137
    ...
    TabOrder = 5
    Visible = False
    OnClick = VideoPlayerPanelClick
    object VideoPlayer: TMediaPlayer
      Left = 16
      Top = 43
      Width = 253
      Height = 38
  ...
  object BrowsePanel: TPanel
    ...
    object MoveLeft: TPanel
      ...
      OnMouseEnter = MoveLeftMouseEnter
      OnMouseLeave = MoveLeftMouseLeave
    end
    object MoveRight: TPanel
      Left = 336
      Top = 80
      Width = 73
      Height = 73
      ...
      OnMouseEnter = MoveRightMouseEnter
      OnMouseLeave = MoveRightMouseLeave
    end
  ...
  object ConfPanel: TPanel
    ...
    object ConfOK: TPanel
      ...
      TabOrder = 0
      OnClick = ConfOKClick
      OnMouseEnter = ConfOKMouseEnter
      OnMouseLeave = ConfOKMouseLeave
    end
    object ConfClose: TPanel
      Left = 16
      Top = 16
      Width = 19
      Height = 25
      ...
      ParentFont = False
      TabOrder = 1
      OnClick = ConfCloseClick
      OnMouseEnter = ConfCloseMouseEnter
      OnMouseLeave = ConfCloseMouseLeave
    end
    object ConfText: TPanel
      Left = -151
      Top = 66
      Width = 185
      Height = 41
    ...
    object ConfCancel: TPanel
      ...
      ParentFont = False
      TabOrder = 3
      OnClick = ConfCancelClick
      OnMouseEnter = ConfCancelMouseEnter
      OnMouseLeave = ConfCancelMouseLeave
    end
  end
  object SettingsPanel: TPanel
    ...
    object RefreshButton: TPanel
      ...
      OnMouseEnter = RefreshButtonMouseEnter
      OnMouseLeave = RefreshButtonMouseLeave
    end
    object LaunchAdminButton: TPanel
      Left = 97
      Top = 55
      Width = 185
      Height = 41
      ...
      ParentFont = False
      TabOrder = 4
      OnClick = LaunchAdminButtonClick
      OnMouseEnter = LaunchAdminButtonMouseEnter
      OnMouseLeave = LaunchAdminButtonMouseLeave
    end
  end
  object SignUpPanel: TPanel
    Left = 8
    Top = 153
    Width = 504
    Height = 250
    ...
    object cPasswordField: TMaskEdit
      Left = 272
      Top = 109
      Width = 121
      Height = 23
    ...
    object SignUpCancel: TPanel
      ...
      ParentFont = False
      TabOrder = 4
      OnClick = SignUpCancelClick
      OnMouseEnter = SignUpCancelMouseEnter
      OnMouseLeave = SignUpCancelMouseLeave
    end
    object SubmitSignupButton: TPanel
      Left = 240
      Top = 151
      Width = 185
      Height = 41
      ...
      ParentFont = False
      TabOrder = 5
      OnClick = SubmitSignupButtonClick
      OnMouseEnter = SubmitSignupButtonMouseEnter
      OnMouseLeave = SubmitSignupButtonMouseLeave
    end
  end
  object WebBackground: TPanel
    Left = -8
    Top = 56
    Width = 426
    Height = 201
    ...
    object WebBrowser: TWebBrowser
      ...
      TabOrder = 0
      ControlData = {
        4C0000002E8D0000604F00000000000000000000000000000000000000000000
